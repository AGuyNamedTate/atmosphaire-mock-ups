                ...
                <Row>
                    <div className="card border-primary mb-3" style={{minHeight:"12.9rem", maxWidth:"20rem", margin:"auto"}} >
                        <div className="card-body">
                            ...
                            <Link to="/team"><button type="button" class="btn btn-outline-primary">Team</button></Link>
                        </div>
                    </div>
                    <div className="card border-primary mb-3" style={{minHeight:"12.9rem", maxWidth:"20rem", margin:"auto"}} >
                        <div className="card-body">
                            ...
                            <Link to="/about"><button type="button" class="btn btn-outline-primary">About</button></Link>
                        </div>
                    </div>
                    <div className="card border-primary mb-3" style={{minHeight:"12.9rem", maxWidth:"20rem", margin:"auto"}} >
                        <div className="card-body">
                            ...
                            <Link to="/gallery"><button type="button" class="btn btn-outline-primary">Gallery</button></Link>
                            <Link to="/services"><button type="button" class="btn btn-outline-primary">Services</button></Link>
                        </div>
                    </div>
                </Row>
            </div>
